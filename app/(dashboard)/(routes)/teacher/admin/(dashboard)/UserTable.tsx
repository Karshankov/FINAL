...
const UserTable: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(fetchUsers, 8000); // Обновляем данные каждые 5 секунды
  ...
  const columns: ColumnDef<User>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        // Проверяем, если user.public_metadata.role не равен "Студент", то отображаем DropdownMenu
        if (user.public_metadata.role !== "Студент") {
          return (
            <DropdownMenu>
        ...
        // Если user.public_metadata.role равен "Студент", не отображаем DropdownMenu
        return null;
      },
    },
  ];
